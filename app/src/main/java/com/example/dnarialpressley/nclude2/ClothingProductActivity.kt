...
class ClothingProductActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        navView.setNavigationItemSelectedListener(NavigationView.OnNavigationItemSelectedListener { menuItem ->
            when (menuItem.itemId) {
                R.id.pantItem -> {
                    val intent = Intent(this@ClothingProductActivity, PantsProductActivity::class.java)
                    startActivity(intent)
                    true
                }
                R.id.techItem -> {
                    val intent = Intent(this@ClothingProductActivity, MainProductActivity::class.java)
                    startActivity(intent)
                    true
                }
                R.id.shoeItem -> {
                    val intent = Intent(this@ClothingProductActivity, ShoeProductActivity::class.java)
                    startActivity(intent)
                    true
                }
                R.id.clothItem -> {
                    //val intent = Intent(this@ClothingProductActivity, ClothingProductActivity::class.java)
                    //startActivity(intent)
                    true
                }
                R.id.contactUs -> {
                    val intent = Intent(this@ClothingProductActivity, FeedBackActivity::class.java)
                    startActivity(intent)
                    true
                }
                else -> false
        ...
        itemQuery.addListenerForSingleValueEvent(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                Realm.init(this@ClothingProductActivity)
                ...
                val layoutManager = LinearLayoutManager(this@ClothingProductActivity)
