    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        navView.setNavigationItemSelectedListener(NavigationView.OnNavigationItemSelectedListener { menuItem ->
            when (menuItem.itemId) {
                R.id.pantItem -> {
                    val intent = Intent(this@MainProductActivity, PantsProductActivity::class.java)
                    startActivity(intent)
                    true
                }
                R.id.techItem -> {
                    //val intent = Intent(this@MainProductActivity, MainProductActivity::class.java)
                    //startActivity(intent)
                    true
                }
                R.id.shoeItem -> {
                    val intent = Intent(this@MainProductActivity, ShoeProductActivity::class.java)
                    startActivity(intent)
                    true
                }
                R.id.clothItem -> {
                    val intent = Intent(this@MainProductActivity, ClothingProductActivity::class.java)
                    startActivity(intent)
                    true
                }
                R.id.contactUs -> {
                    val intent = Intent(this@MainProductActivity, FeedBackActivity::class.java)
                    startActivity(intent)
                    true
                }
                else -> false
        ...
        itemQuery.addListenerForSingleValueEvent(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                Realm.init(this@MainProductActivity)
                ...
                val layoutManager = LinearLayoutManager(this@MainProductActivity)
