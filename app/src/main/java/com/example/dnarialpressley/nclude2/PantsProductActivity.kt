...
class PantsProductActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        navView.setNavigationItemSelectedListener(NavigationView.OnNavigationItemSelectedListener { menuItem ->
            when (menuItem.itemId) {
                ...
                R.id.techItem -> {
                    val intent = Intent(this@PantsProductActivity, MainProductActivity::class.java)
                    startActivity(intent)
                    true
                }
                R.id.shoeItem -> {
                    val intent = Intent(this@PantsProductActivity, ShoeProductActivity::class.java)
                    startActivity(intent)
                    true
                }
                R.id.clothItem -> {
                    val intent = Intent(this@PantsProductActivity, ClothingProductActivity::class.java)
                    startActivity(intent)
                    true
                }
                R.id.contactUs -> {
                    val intent = Intent(this@PantsProductActivity, FeedBackActivity::class.java)
                    startActivity(intent)
                    true
                }
                else -> false
        ...
        itemQuery.addListenerForSingleValueEvent(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                Realm.init(this@PantsProductActivity)
                ...
                val layoutManager = LinearLayoutManager(this@PantsProductActivity)
